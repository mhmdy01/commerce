...
urlpatterns = [
    ...
    path("listings/<int:listing_id>/watchlist/add", views.add_to_watchlist, name="add_to_watchlist"),
    path("listings/<int:listing_id>/watchlist/remove", views.remove_from_watchlist, name="remove_from_watchlist"),
